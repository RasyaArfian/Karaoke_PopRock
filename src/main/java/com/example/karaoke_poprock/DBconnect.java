...
public class DBconnect {
    ...
    private static final String USER = "Letya";
    private static final String PASS = "letya";
    ...
    public DBconnect() {
        try{
            String url = "jdbc:sqlserver://localhost;database=Db_karaoke_poprock;user=Letya;password=letya";
